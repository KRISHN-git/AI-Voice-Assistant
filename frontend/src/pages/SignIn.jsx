...
try {
 ...
 <form className='w-[90%] h-[500px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
<h1 className='text-white text-[30px] font-semibold mb-[30px]'>Sign In to <span className='text-teal-400'>Voice Buddy</span></h1>
...
<p className='text-[white] text-[18px] cursor-pointer' onClick={()=>navigate("/signup")}>Create a new account ? <span className='text-teal-400'>Sign Up</span></p>
 </form>
    </div>
  )
}
